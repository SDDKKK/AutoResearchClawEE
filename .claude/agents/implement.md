...
**Tool routing**:
- Code search: `warpgrep_codebase_search` (broad semantic) or `codebase-retrieval` (deep understanding) or Grep (exact match). If morph-mcp unavailable, use `codebase-retrieval` for all semantic search.
