...
| Script | No API keys | +JINA_API_KEY | +TAVILY_API_KEY | +CF keys | +MINERU_TOKEN | All keys |
|--------|:-----------:|:-------------:|:---------------:|:--------:|:-------------:|:--------:|
| `web_fetch.py` | Tier 1-2 (Jina free 20 RPM) | Tier 1-2 (500 RPM) | +Tier 4 | +Tier 3 | +Tier 5 | All 5 tiers |
